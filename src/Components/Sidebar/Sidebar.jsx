    ...
    <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
        <div className='shortcut-links'>
            ...
            <div className={`side-link ${category===24?"active":""}`} onClick={()=>setCategory(24)}>
                <img src={entertaiment} alt="entertainment-icon" /> <p>Entertaiment</p>
            </div>
        ...
        <div className='subscribed-list'>
            ...
            <div className='side-link'>
                <img src={jack} alt='jack-img' /> <p>PewDiePie</p>
            </div>
            <div className='side-link'>
                <img src={simon} alt='jack-img' /> <p>Mrbeast</p>
            </div>
            <div className='side-link'>
                <img src={tom} alt='tom-img' /> <p>Justin Bieber</p>
            </div>
            <div className='side-link'>
                <img src={megan} alt='megan-img' /> <p>5-Minute Craft</p>
            </div>
            <div className='side-link'>
                <img src={cameron} alt='cameron-img' /> <p>Nas Daily</p>
            </div>
        </div>
    </div>
  )
