    ...
    return (
        <div className='play-video'>
            ...
            <div className='play-video-info'>
                <p>{apiData?value_converter(apiData.statistics.viewCount):"0"} Views &bull; {apiData?moment(apiData.snippet.publishedAt).fromNow():"Couldnt Moment publishedAt"}</p>
                <div>
                    <span><img src={like} alt='like-icon'/>{apiData?value_converter(apiData.statistics.likeCount):0}</span>
                    <span><img src={dislike} alt='dislike-icon'/></span>
                    <span><img src={share} alt='share-icon'/>Share</span>
                    <span><img src={save} alt='like-icon'/>Save</span>
                </div>
            </div>
            <hr/>
            <div className='publisher'>
                <img src={channelData?channelData.snippet.thumbnails.default.url:""} alt='jack-profile' />
                <div>
